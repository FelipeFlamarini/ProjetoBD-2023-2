SELECT pessoa.nome, cidade.nome, tipo_plano.nome FROM pessoa, cidade, tipo_plano, funcionario
WHERE funcionario.pessoa_id = pessoa.id
...
SELECT pessoa.nome AS pessoa, cidade.nome AS cidade, tipo_plano.nome AS plano FROM funcionario
...
SELECT pessoa.nome AS pessoa, cidade.nome AS cidade FROM pessoa
...
INSERT INTO funcionario VALUES (9, 010101, 28000);